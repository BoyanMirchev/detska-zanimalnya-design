...
const gallery = [
  ...
  { src: "/images/photo-blue-room.png", alt: "Деца играят и учат заедно в занималнята", cls: "" },
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-12 grid gap-5 lg:grid-cols-3">
            {[
              ...
              ["Николай К.", "Баща на Ема", "Харесва ми, че има структура, но децата не са натоварени излишно. Ком��никацията с екипа е ясна и навременна."],
